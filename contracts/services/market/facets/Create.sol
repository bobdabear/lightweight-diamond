...
contract Create is Modifiers{
    ...
    function create(address _base, address _quote, uint _initialPrice) public auth returns (address)  {   
        address newMarket = address(new Orderbook(_base, _quote, _initialPrice, address(this)));
