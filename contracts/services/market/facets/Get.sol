...
contract Get is Modifiers{
    ...
    function getMarketsFor(address _token) public view returns (address[] memory) {
        return s.markets[_token];
    }

    function getOrderbook(address _base, address _quote) public view returns (address) {
