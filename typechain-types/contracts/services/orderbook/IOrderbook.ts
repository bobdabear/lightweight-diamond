...
export interface IOrderbookInterface extends Interface {
  getFunction(nameOrSignature: "order"): FunctionFragment;

  encodeFunctionData(functionFragment: "order", values: [BigNumberish]): string;
...
export interface IOrderbook extends BaseContract {
  ...
  order: TypedContractMethod<[_price: BigNumberish], [void], "nonpayable">;
