...
export interface CancelInterface extends Interface {
  getFunction(nameOrSignature: "cancel" | "liquidation"): FunctionFragment;
...
export interface Cancel extends BaseContract {
  connect(runner?: ContractRunner | null): Cancel;
