...
export interface DiamondContractManagerInterface extends Interface {
  getEvent(
...
export interface DiamondContractManager extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondContractManager;
  waitForDeployment(): Promise<this>;

  interface: DiamondContractManagerInterface;
