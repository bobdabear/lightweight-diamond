...
export interface DiamondFacadeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "checkInterface"
      | "checkPermission"
...
export interface DiamondFacade extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondFacade;
  waitForDeployment(): Promise<this>;

  interface: DiamondFacadeInterface;
